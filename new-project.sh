...
echo "  4. On first launch, click 'Trust' when prompted for the 3 marketplaces"
echo "     (compound-engineering, superpowers, claude-code-skills) — pre-declared"
echo "     in .claude/settings.json. Optional plugins live in plugins.txt."
